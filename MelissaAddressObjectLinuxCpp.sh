...
# MelissaAddressObjectLinuxCpp
#
# Downloads the required components and then builds and runs MelissaAddressObjectLinuxCpp.
#
...
#
# Examples:
#   ./MelissaAddressObjectLinuxCpp.sh --license "your-license"
#   ./MelissaAddressObjectLinuxCpp.sh --address "22382 Avenida Empresa" --city "Rancho Santa Margarita" --state "CA" --zip "92688" --license "your-license"
...
while [ $# -gt 0 ] ; do
    case $1 in
        ...
        --dataPath) 
            ...
            if [ "$dataPath" == "--city" ] || [ "$dataPath" == "--state" ] || [ "$dataPath" == "--address" ] || [ "$dataPath" == "--zip" ] || [ "$zip" == "--license" ] || [ "$zip" == "--quiet" ] || [ -z "$zip" ];
            then
